...
using Tyuiu.KhrapovDY.Sprint6.Task7.V3.Lib;
using static System.Windows.Forms.VisualStyles.VisualStyleElement;

namespace Tyuiu.KhrapovDY.Sprint6.Task7.V3
{
    public partial class FormMain : Form
    {
        public FormMain()
        {
            ...
            openFileDialogTask_KDY.Filter = "Значения, разделенные запятыми(*.csv)|*.csv|Все файлы(*.*)|*.* ";
            saveFileDialogMatrix_KDY.Filter = "Значения, разделенные запятыми(*.csv)|*.csv|Все файлы(*.*)|*.*";
        }
